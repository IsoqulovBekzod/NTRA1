                                ...
                                <form id="ads-create" action="/branch/create" method="post" enctype="multipart/form-data">
                                    <div class="grid grid-cols-12 gap-5">
                                        <div class="col-span-12">
                                            <label for="title" class="font-medium">Filial</label>
                                            <input name="name" id="title" type="text" class="form-input mt-2" placeholder="Filial :">
                                        </div>
                                    ...
                                    <div class="grid grid-cols-12 gap-5">
                                        <div class="col-span-12">
                                            ...
                                            <input name="address" id="title" type="text" class="form-input mt-2" placeholder="Address :">
                                        </div>
