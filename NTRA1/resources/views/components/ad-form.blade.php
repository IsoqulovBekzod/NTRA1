                    ...
                    <div class="col-span-12">
                        ...
                        <div class="form-icon relative mt-2">
                            <select
                                ...
                                <option selected disabled hidden>Kim uchun</option>
                                <option value="erkak" {{ (isset($ad) && $ad->gender === 'erkak') ? 'selected' : '' }}>
                                    Erkak
                                </option>
                                <option value="ayol" {{ (isset($ad) && $ad->gender === 'ayol') ? 'selected' : '' }}>
                                    Ayol
                                </option>
                            </select>
                        </div>
